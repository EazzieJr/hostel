    ...
    <section class="login flex justify-center bg-[#F8F9FA]">
      ...
      >
        ...
        <div class="info py-10 space-y-4">
          <h1
            class="text-4xl font-semibold text-center lg:text-left text-white leading-tight lg:px-16"
          >
        ...
        <div class="form lg:hidden flex justify-center items-center">
          ...
          >
            ...
            <div
              class="pricing w-full p-3 mt-5 flex justify-between items-center border rounded-2xl"
            >
